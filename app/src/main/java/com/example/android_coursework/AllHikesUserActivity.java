...
public class AllHikesUserActivity extends AppCompatActivity {
    ...
    private void searchHikes(String keyword) {
        ...
        Log.d("AllHikesUser", "🔎 Found hikes: " + hikeList.size());
    }
    ...
    private void filterByParking() {
        ...
        adapter.notifyDataSetChanged();
        Log.d("AllHikesUser", "🚗 Filtered by parking (Yes): " + hikeList.size());
    }
    ...
    private void filterBySingleDifficulty(String level) {
        ...
        adapter.notifyDataSetChanged();
        Log.d("AllHikesUser", "💪 Filtered by difficulty: " + level + " → " + hikeList.size());
    }

    // 🧩 Load tất cả hikes (không theo user)
    private void loadAllHikes() {
        ...
        adapter.notifyDataSetChanged();
        Log.d("AllHikesUser", "📍 Reloaded all hikes: " + hikeList.size());
    }
